...
// next step
// make dropdown for codebook selection, using same useCodebooks hook
// Make form for codebook. Try to make this a single form that can switch between
// types for variables. OR, make the creation of codebook and variables separate,
// and also store variables separately in database

// in any case, use the browser option to warn before closing window if editing still in progres
