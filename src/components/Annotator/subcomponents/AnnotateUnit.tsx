...
import { FullScreenNode, JobServer, SetUnitIndex, Unit, SessionData, CodeBook } from "@/app/types";
...
const AnnotateUnit = ({ unit, jobServer, unitIndex, setUnitIndex, fullScreenNode }: AnnotateUnitProps) => {
