...
import { Token, TokenSelection, Arrowkeys, AnnotationLibrary, VariableType, Mover } from "@/app/types";
...
export default function useAnnotationEvents(
  ...
  const [holdArrow, setHoldArrow] = useState<Arrowkeys | null>(null);
  ...
  }, [tokens, mover, holdArrow, holdSpace, setCurrentToken, editMode, annotationLib, setTokenSelection, sameFieldOnly]);
