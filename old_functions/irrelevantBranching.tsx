import { AnswerOption, AnswerItem, CodeTree } from "@/app/types";
import { addAnnotationsFromAnswer } from "./mapAnswersToAnnotations";
import { Question, Answer } from "@/app/types";

export function processIrrelevantBranching(unit: any, questions: Question[], answers: Answer[], questionIndex: number) {
