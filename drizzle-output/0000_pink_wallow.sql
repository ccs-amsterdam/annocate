CREATE TABLE IF NOT EXISTS "annotations" (
	...
	"status" text,
	CONSTRAINT annotations_job_id_user_id_index PRIMARY KEY("job_id","user_id","index")
);
...
CREATE TABLE IF NOT EXISTS "annotators" (
	...
	CONSTRAINT annotators_job_id_user_id PRIMARY KEY("job_id","user_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "managers" (
	...
	"user_id" integer NOT NULL,
	"role" text NOT NULL,
	CONSTRAINT managers_job_id_user_id PRIMARY KEY("job_id","user_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "unit_group_units" (
	"unit_group_id" integer NOT NULL,
	"unit_id" integer NOT NULL,
	CONSTRAINT unit_group_units_unit_group_id_unit_id PRIMARY KEY("unit_group_id","unit_id")
);
--> statement-breakpoint
