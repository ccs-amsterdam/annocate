...
import { SwipeOptions, Swipes, AnswerItem, OnSelectParams, AnswerOption } from "@/app/types";
...
const Annotinder = ({ answerItems, swipeOptions, onSelect, swipe, blockEvents }: AnnotinderProps) => {
